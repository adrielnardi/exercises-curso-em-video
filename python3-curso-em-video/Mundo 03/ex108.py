...
print(f'Aumento de 10%: {moeda.aumentarEx108(valor, 10)}')
print(f'Rezudino 15%: {moeda.diminuirEx108(valor, 15)}')
print(f'O dobro de {moeda.moedaEx108(valor, "$")} é: {moeda.dobroEx108(valor)}')
print(f'A metade de {moeda.moedaEx108(valor)} é: {moeda.metadeEx108(valor)}')
